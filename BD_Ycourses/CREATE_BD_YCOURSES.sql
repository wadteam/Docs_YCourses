...
CREATE TABLE IF NOT EXISTS `bd_ycourses`.`perfil_alumno` (
  ...
  INDEX `fk_perfil_alumno_alumno_idx` (`alumno_idalumno` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bd_ycourses`.`empresa` (
  ...
  INDEX `fk_empresa_ciudad1_idx` (`ciudad_idciudad` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bd_ycourses`.`cuenta_empresa` (
  ...
  INDEX `fk_cuenta_empresa_empresa1_idx` (`empresa_rutempresa` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bd_ycourses`.`relator` (
  ...
  INDEX `fk_relator_ciudad1_idx` (`ciudad_idciudad` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bd_ycourses`.`perfil_relator` (
  ...
  `imagen_perfil` MEDIUMBLOB NULL,
  INDEX `fk_perfil_relator_relator1_idx` (`relator_idRelator` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bd_ycourses`.`contrato` (
  ...
  `estado` VARCHAR(30) NOT NULL,
  INDEX `fk_contrato_relator1_idx` (`relator_idRelator` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bd_ycourses`.`servicio` (
  ...
  INDEX `fk_servicio_tipo_servicio1_idx` (`tipo_servicio_idtipo_servicio` ASC) VISIBLE,
  INDEX `fk_servicio_relator1_idx` (`relator_rutrelator` ASC) VISIBLE,
  INDEX `fk_servicio_ciudad1_idx` (`ciudad_idciudad` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bd_ycourses`.`nomina_alumno_servicio` (
  ...
  INDEX `fk_alumno_servicio_alumno1_idx` (`alumno_idalumno` ASC) VISIBLE,
  INDEX `fk_alumno_servicio_servicio1_idx` (`servicio_idservicio` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bd_ycourses`.`certificado` (
  ...
  INDEX `fk_certificado_nomina_alumno_servicio1_idx` (`nomina_alumno_servicio_id_alumno_servicio` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bd_ycourses`.`historial_certificado` (
  ...
  INDEX `fk_historial_certificado_certificado1_idx` (`certificado_idcertificado` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bd_ycourses`.`perfil_servicio` (
  ...
  INDEX `fk_perfil_servicio_servicio1_idx` (`servicio_idservicio` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bd_ycourses`.`nomina_empresa_alumno` (
  ...
  INDEX `fk_nomina_alumnos_empresa1_idx` (`empresa_rutempresa` ASC) VISIBLE,
  INDEX `fk_nomina_alumnos_alumno1_idx` (`alumno_idalumno` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bd_ycourses`.`contrato_servicio` (
  ...
  INDEX `fk_contrato_servicio_empresa1_idx` (`empresa_rutempresa` ASC) VISIBLE,
  INDEX `fk_contrato_servicio_servicio1_idx` (`servicio_idservicio` ASC) VISIBLE,
  INDEX `fk_contrato_servicio_nomina_empresa_alumno1_idx` (`nomina_empresa_alumno_idnomina_alumnos` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bd_ycourses`.`calificacion` (
  ...
  INDEX `fk_calificacion_relator1_idx` (`relator_rutrelator` ASC) VISIBLE,
  INDEX `fk_calificacion_nomina_alumno_servicio1_idx` (`nomina_alumno_servicio_id_alumno_servicio` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bd_ycourses`.`venta_servicio` (
  ...
  INDEX `fk_compra_servicio_alumno1_idx` (`alumno_idalumno` ASC) VISIBLE,
  INDEX `fk_venta_servicio_servicio1_idx` (`servicio_idservicio` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bd_ycourses`.`perfil_empresa` (
  ...
  INDEX `fk_perfil_empresa_empresa1_idx` (`empresa_rutempresa` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `bd_ycourses`.`table1`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bd_ycourses`.`table1` ;

CREATE TABLE IF NOT EXISTS `bd_ycourses`.`table1` (
)
ENGINE = InnoDB;
