...
CREATE TABLE IF NOT EXISTS `bd_ycourses`.`perfil_relator` (
  ...
  `imagen_perfil` MEDIUMBLOB NULL,
  INDEX `fk_perfil_relator_relator1_idx` (`relator_rutrelator` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bd_ycourses`.`contrato` (
  ...
  `estado` VARCHAR(30) NOT NULL,
  INDEX `fk_contrato_relator1_idx` (`relator_rutrelator` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bd_ycourses`.`tipo_servicio` (
  ...
  INDEX `fk_tipo_servicio_area1_idx` (`area_idarea` ASC) VISIBLE,
  INDEX `fk_tipo_servicio_categoria_tipo_servicio1_idx` (`categoria_tipo_servicio_idcategoria_tipo_servicio` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bd_ycourses`.`contrato_servicio` (
  ...
  INDEX `fk_contrato_servicio_nomina_empresa1_idx` (`nomina_empresa_idnomina_empresa` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bd_ycourses`.`venta_servicio` (
  ...
  INDEX `fk_venta_servicio_alumno1_idx` (`alumno_idalumno` ASC) VISIBLE,
  CONSTRAINT `fk_venta_servicio_servicio1`
    FOREIGN KEY (`servicio_idservicio`)
    REFERENCES `bd_ycourses`.`servicio` (`idservicio`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_venta_servicio_alumno1`
    FOREIGN KEY (`alumno_idalumno`)
    REFERENCES `bd_ycourses`.`alumno` (`idalumno`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `bd_ycourses`.`nomina_empresa_alumnos` (
  ...
  INDEX `fk_nomina_empresa_alumnos_alumno1_idx` (`alumno_idalumno` ASC) VISIBLE,
  INDEX `fk_nomina_empresa_alumnos_nomina_empresa1_idx` (`nomina_empresa_idnomina_empresa` ASC) VISIBLE,
